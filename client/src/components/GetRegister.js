...
export default function GetRegister() {
  ...
  function downlode() {
      ...
      if (btn === "b4") {
        ...
        b_html = `<br><button style="margin-left:auto;margin-right:auto" class="b9">Register</button>`;
      }else if (btn === "b10") {
        ...
        b_html = `<br><button style="margin-left:auto;margin-right:auto" class="b10">Register</button>`;
      }
              ...
              <div className="col-md-8">
                <div className="card-body" style={{ overflow: "auto",height:"75vh" }}>
                  ...
                  <div className="text-center">
                    <button  type="submit" onClick={downlode} className="btn btn-light mt-4" style={{backgroundColor: "#00008b",color:"white" }}>Download</button>
                  </div>
                </div>
              </div>
            </div>
